...
def project_prompt(*, template: str, name: str, purpose: str, tier: str, project_type: str, nix_level: str) -> str:
...
def migration_prompt(*, template: str, source: Path, tier: str, nix_level: str, evidence: str) -> str:
