...
- 言語: 既定で AGENTS.md / 主 README / source identifier / commit / branch 名は英語。プロジェクトが Japanese-primary を選ぶ場合は brief に明記し、その場合でも T1 public repo の主 `README.md` は英語のままとし、`README.ja.md` を sibling で併置する。
